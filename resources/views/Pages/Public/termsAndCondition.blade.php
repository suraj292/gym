...
@section('content')
    <div id="shopify-section-template--16717966934237__main" class="shopify-section">
        <section class="text-scheme-text bg-scheme-background relative overflow-hidden  " data-color-scheme="primary">
            <div class="section-content py-section-vertical-spacing px-section mx-auto">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Athlete Nutrition Sole
                            Proprietor ship, A 55, B 3 Nikunj Appartment, Shyam Park Extension, Sahibabad, Ghaziabad
                            (201005).</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Athlete Nutrition, accessible from <a
                                href="https://athletenutrition.in" rel="external nofollow noopener" target="_blank">https://athletenutrition.in</a>
                        </p>
                    </li>
                    <li>
