...
<div class="nav-header">
    <div class="brand-logo"><a href="{{ route('admin.dashboard') }}"><h2 style="color: white"><b>Athlete Nutrition </b></h2></a>
    </div>
            ...
            <ul>
                            ...
                            <ul>
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ asset('admin.assets/images/avatar/1.jpg') }}" alt="">
                                ...
                                <li class="notification-unread">
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ asset('admin.assets/images/avatar/2.jpg') }}" alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ asset('admin.assets/images/avatar/3.jpg') }}" alt="">
                                        <div class="notification-content">
                                ...
                                <li>
                                    <a href="javascript:void()">
                                        <img class="pull-left mr-3 avatar-img" src="{{ asset('admin.assets/images/avatar/4.jpg') }}" alt="">
                                        <div class="notification-content">
                ...
                <li class="icons">
                    <a href="javascript:void(0)" class="log-user">
                        <img src="{{ asset('admin.assets/images/avatar/1.jpg') }}" alt=""> <span>George Martin</span>  <i class="fa fa-caret-down f-s-14" aria-hidden="true"></i>
                    </a>
