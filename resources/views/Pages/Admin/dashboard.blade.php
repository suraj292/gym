                        ...
                        <div class="row">
                            <div class="col-sm-3 mb-sm-0">
                                <div class="stat-widget-three py-2">
                                    <div class="media">
                                        <img class="mr-4 mt-3" src="{{ asset('admin.assets/images/icons/4.png') }}" alt="">
                                        <div class="media-body">
                            ...
                            <div class="col-sm-3 mb-sm-0">
                                <div class="stat-widget-three py-2">
                                    <div class="media">
                                        <img class="mr-4 mt-3" src="{{ asset('admin.assets/images/icons/5.png') }}" alt="">
                                        <div class="media-body">
                            ...
                            <div class="col-sm-3">
                                <div class="stat-widget-three py-2">
                                    <div class="media">
                                        <img class="mr-4 mt-3" src="{{ asset('admin.assets/images/icons/6.png') }}" alt="">
                                        <div class="media-body">
                            ...
                            <div class="col-sm-3">
                                <div class="stat-widget-three py-2">
                                    <div class="media">
                                        <img class="mr-4 mt-3" src="{{ asset('admin.assets/images/icons/7.png') }}" alt="">
                                        <div class="media-body">
            ...
            <div class="col-lg-3">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="stat-widget-three py-2">
                            <div class="media">
                                <img class="mr-4" src="{{ asset('admin.assets/images/icons/8.png') }}" alt="">
                                <div class="media-body">
